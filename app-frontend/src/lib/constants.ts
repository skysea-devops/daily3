export const CATEGORIES: {
  ...
  { id: "Fashion & Style",      label: "Fashion & Style",      emoji: "👗", description: "Style, design, fashion industry and culture" },
...
export const SUB_TOPICS: Record<string, string[]> = {
  ...
  "Fashion & Style":      ["Clothing & Accessories", "Beauty & Cosmetics", "Lifestyle", "Trend Analysis", "Design & Creativity", "Industry Insights"],
